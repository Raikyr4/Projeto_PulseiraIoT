#informar que alguem conhecido esta chegando 3 
# ou algo do tipo e imlpementar algo novo como uma intertface grafica
#gravação e leitura de arquivo , implementara algo que envolva isso 
import math
import random
import time
